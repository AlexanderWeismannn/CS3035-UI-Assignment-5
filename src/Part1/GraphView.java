...
public class GraphView extends Pane {
    ...
    private Color DEFAULT_VERTEX_COLOR = Color.LIGHTBLUE;
    private Color SELECTED_VERTEX_COLOR = Color.ORANGE;
    ...
    GraphView(){
        ...
        Main.graphModel.getVertexSimpleListProperty().addListener((ListChangeListener<Vertex>) e ->{
            // finish draw methods
            draw();
        });
    }
